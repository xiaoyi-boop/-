...
local yijiaobenui = loadstring(game:HttpGet("https://raw.githubusercontent.com/JY6812/UI/refs/heads/main/81.lua"))()
local win = yijiaobenui:new("依脚本")
...
about:Label("脚本上次更新时间5月1日")
about:Label("无相关服务器功能自动加载通用")
about:Label("你的地图id:"..game.PlaceId) 
...
about:Button("FE", function()
    ...
    game.Players.LocalPlayer:Kick("傻逼"..game.Players.LocalPlayer.Name.."复制全行不行")
end
